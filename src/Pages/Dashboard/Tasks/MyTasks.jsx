                                    ...
                                    <tbody>

                                        {
                                            myTask.map((task, index) => <tr key={task._id} className='hover:bg-gray-100 hover:text-black transition duration-300 cursor-pointer'>
                                                ...
                                                <td>
                                                    <Link><button className="btn hover:bg-blue-200"><MdOutlineSystemUpdateAlt size={20} /></button></Link>
                                                </td>
                                                <td>
                                    ...
                                    myTask.map((task, index) => (
                                        <div key={task._id} className="bg-base-100 p-4 rounded-lg shadow-xl/15 space-y-2 border-2 border-gray-600">
                                            ...
                                            <div className="flex justify-between items-center mt-6">
                                                ...
                                                <button onClick={handleDelete} className="btn hover:bg-red-200"><MdDelete size={20} /></button>
                                            </div>
                                        </div>
                                    ))
                                }
