...
const Login = () => {
    ...
    return (
        <div className="card bg-base-100 w-full mx-auto mt-12 max-w-sm shrink-0 shadow-2xl bg-amber-200">
            ...
            <div className="card-body">
                ...
                <button onClick={handleGoogleSignIn} className="btn bg-base-100 text-base-content border-[#e5e5e5]">
