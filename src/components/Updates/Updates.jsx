...
const Updates = () => {
    return (
        <section className="py-6 bg-base-100 shadow-xl/20 mt-12 rounded-2xl">
            <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
                <div className="flex flex-col justify-center lg:text-left">
                    <p className="mb-1 text-sm font-medium tracking-widest uppercase text-violet-600">
                        Exceptional Services Tailored For You
                    </p>
                    <h1 className="py-2 text-3xl font-medium leading-tight title-font">
                        Experience the Best Cleanse and Care
                    </h1>
                </div>
                <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
                    <button className="inline-flex items-center px-6 py-3 rounded-lg bg-violet-600 text-gray-50 hover:bg-violet-700 transition">
                        <svg
                    ...
                    <button className="inline-flex items-center px-5 py-3 rounded-lg bg-violet-600 text-gray-50 hover:bg-violet-700 transition">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 50 50"
                            className="fill-current w-7 h-7 text-gray-50"
